...
func (c *Client) ListOrders(ctx context.Context) ([]OrderSummary, error) {
	...
	err := c.doRequest(ctx, http.MethodGet, c.BaseURL().JoinPath("sar", "orders"), nil, http.StatusOK, &out)
	return out, err
}
...
func (c *Client) GetOrder(ctx context.Context, orderID string) (*Order, error) {
	var out Order
	err := c.doRequest(ctx, http.MethodGet, c.BaseURL().JoinPath("sar", "orders", orderID), nil, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) UpdateOrder(ctx context.Context, orderID string, req *UpdateOrderRequest) (*Order, error) {
	...
	var out Order
	err = c.doRequest(ctx, http.MethodPatch, c.BaseURL().JoinPath("sar", "orders", orderID), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) GetOrderItems(ctx context.Context, req *GetOrderItemsRequest) (*FeatureCollection, error) {
	...
	err = c.doRequest(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "orders", "*", "items"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) GetOrderItemsStatus(ctx context.Context, req *GetOrderItemsStatusRequest) (*OrderItemsStatusResponse, error) {
	...
	err = c.doRequest(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "orders", "*", "items", "status"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) CancelOrderItems(ctx context.Context, req *CancelItemsRequest) (*CancelItemsResponse, error) {
	...
	err = c.doRequest(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "orders", "cancel"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) ReorderItems(ctx context.Context, req *ReorderRequest) (*Basket, error) {
	...
	var out Basket
	err = c.doRequest(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "orders", "reorder"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) SubmitOrder(ctx context.Context, req *SubmitOrderRequest) (*Order, error) {
	...
	var out Order
	err = c.doRequest(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "orders", "submit"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) UpdateOrderOptions(ctx context.Context, req *UpdateOrderOptionsRequest) error {
	...
	return c.doRequest(ctx, http.MethodPatch, c.BaseURL().JoinPath("sar", "orderOptions"), body, http.StatusOK, nil)
}
