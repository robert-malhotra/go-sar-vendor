...
func (c *Client) ListBaskets(ctx context.Context) ([]Basket, error) {
	var out []Basket
	err := c.DoRaw(ctx, http.MethodGet, c.BaseURL().JoinPath("sar", "baskets"), nil, http.StatusOK, &out)
	return out, err
}
...
func (c *Client) CreateBasket(ctx context.Context, req *CreateBasketRequest) (*Basket, error) {
	...
	var out Basket
	err = c.DoRaw(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "baskets"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) GetBasket(ctx context.Context, basketID string) (*Basket, error) {
	var out Basket
	err := c.DoRaw(ctx, http.MethodGet, c.BaseURL().JoinPath("sar", "baskets", basketID), nil, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) UpdateBasket(ctx context.Context, basketID string, req *UpdateBasketRequest) (*Basket, error) {
	...
	var out Basket
	err = c.DoRaw(ctx, http.MethodPatch, c.BaseURL().JoinPath("sar", "baskets", basketID), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) ReplaceBasket(ctx context.Context, basketID string, req *ReplaceBasketRequest) (*Basket, error) {
	...
	var out Basket
	err = c.DoRaw(ctx, http.MethodPut, c.BaseURL().JoinPath("sar", "baskets", basketID), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) DeleteBasket(ctx context.Context, basketID string) error {
	return c.DoRaw(ctx, http.MethodDelete, c.BaseURL().JoinPath("sar", "baskets", basketID), nil, http.StatusNoContent, nil)
}
...
func (c *Client) AddItemsToBasket(ctx context.Context, basketID string, req *AddItemsRequest) (*Basket, error) {
	...
	var out Basket
	err = c.DoRaw(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "baskets", basketID, "addItems"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) RemoveItemsFromBasket(ctx context.Context, basketID string, req *RemoveItemsRequest) (*Basket, error) {
	...
	var out Basket
	err = c.DoRaw(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "baskets", basketID, "removeItems"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) RearrangeBasketItems(ctx context.Context, basketID string, req *RearrangeItemsRequest) (*Basket, error) {
	...
	var out Basket
	err = c.DoRaw(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "baskets", basketID, "rearrangeItems"), body, http.StatusOK, &out)
	return &out, err
}
...
func (c *Client) SubmitBasket(ctx context.Context, basketID string) (*Order, error) {
	var out Order
	err := c.DoRaw(ctx, http.MethodPost, c.BaseURL().JoinPath("sar", "baskets", basketID, "submit"), nil, http.StatusOK, &out)
	return &out, err
}
