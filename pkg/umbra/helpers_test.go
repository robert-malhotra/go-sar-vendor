...
func newTestClient(t *testing.T, handler http.HandlerFunc) (*umbra.Client, *httptest.Server) {
	t.Helper()
...
// requireAuth checks that the request has the expected bearer token.
func requireAuth(t *testing.T, r *http.Request, expectedToken string) {
	t.Helper()
